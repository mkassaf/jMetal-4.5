...
public class TSPGA_main {
  ...
  public static void main(String [] args)  throws FileNotFoundException, 
    ...
    String problemName = "C:/Users/massaf/Dropbox/Master Software Engineering/Search-Based Software Engineering/Assiagments/Assigment 1/att48.tsp";
    ...
    // Algorithm params
    algorithm.setInputParameter("populationSize",48);
    //"10 000 000"
    algorithm.setInputParameter("maxEvaluations",90000000);
    ...
    System.out.println("Run number : "+args[0]);
    ...
    population.printObjectivesToFile("result\\FUN"+args[0]);
    System.out.print("Objectives :");
    population.printObjectives();
    System.out.println("Variables values have been writen to file VAR");
    population.printVariablesToFile("result\\VAR"+args[0]);          
  }//main
} // TSPGA_main
